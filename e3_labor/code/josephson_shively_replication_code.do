...
* panel A
	tabstat 		wages_farmlabor femhead plough own_cattle free_seed intercrop fertqty area /// 
						no_farm_fulltime no_farm_parttime	
* panel B
...
* panel B
	tabstat 		ae hhage hhedu femhead 

* panel C
	tabstat 		workdeath commworkdeath shocktotal pershock 
...
* for omitted (non) share equation for model							 
	...
	quietly 			lincom -([share_off]did_comworkdeathyr + [share_mig]did_comworkdeathyr + [share_farm]did_comworkdeathyr)
							...
							scalar e18=r(se)
							scalar t18=b18/e18	
	quietly				lincom -([share_off]did_shock + [share_mig]did_shock + [share_farm]did_shock)
...
* estimate shadow wage for migrant labor 
	xtreg 			wages_migrant avgmig_gender avgmig_age avgmig_yred multiple_mig ///
						...
						mo_migrant_domestic mno_migrants mcomm_migrantratio
