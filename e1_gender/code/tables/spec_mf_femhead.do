...
* **********************************************************************
* 1a - first stage - NON-FEMALE-HEADED - OMIT joint income 
* *********************************************************************
...
* **********************************************************************
* 1b - second stage - NON-FEMALE-HEADED - OMIT joint income
* *********************************************************************
...
esttab AGCONJo CONFOJo CIGSJo CLJo RECJo EDUCJo HEAJo HOUSEJo TRANSJo COMJo HRESJo using table6_mf_o_nf.tex, replace f ///
	label booktabs b(3) se(3) eqlabels(none) alignment(S)  ///
	drop(3* _cons) ///
	star(* 0.10 ** 0.05 *** 0.01) nogaps ///
...
* **********************************************************************
* 2a - first stage - FEMALE-HEADED - OMIT joint income
* *********************************************************************
...
* **********************************************************************
* 2b - second stage - FEMALE-HEADED - OMIT joint income 
* *********************************************************************
...
esttab AGCONJo CONFOJo CIGSJo CLJo RECJo EDUCJo HEAJo HOUSEJo TRANSJo COMJo HRESJo using table6_mfspec_o_f.tex, replace f ///
	label booktabs b(3) se(3) eqlabels(none) alignment(S)  ///
	drop(3* _cons) ///
	star(* 0.10 ** 0.05 *** 0.01) nogaps ///
	order(xbmaleo xbfemaleo) ///
...
* **********************************************************************
* 3a - first stage - NON-FEMALE-HEADED - REALLOCATE joint income
* *********************************************************************
...
* **********************************************************************
* 3b - second stage - NON-FEMALE-HEADED - REALLOCATE joint income
* *********************************************************************
...
* **********************************************************************
* 4a - first stage - FEMALE-HEADED - REALLOCATE joint income
* *********************************************************************
...
* **********************************************************************
* 4b - second stage - FEMALE-HEADED - REALLOCATE joint income
* *********************************************************************
