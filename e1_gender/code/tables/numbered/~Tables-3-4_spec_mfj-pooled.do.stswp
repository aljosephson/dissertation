...
* set local for male, female, and joint 
	...
	local jincome (lnvaluejoint_jspecw totalr i.ssa_aez)
	local fincome (lnvaluefemale_jspecw totalr i.ssa_aez)
	local mincome (lnvaluemale_jspecw totalr i.ssa_aez)
...
esttab INJM INJF INJJ using table3_rain-mfj-pooled.tex, replace f ///
...
* consumption aggregates based on WB aggregates provided in LSMS downloads
	...
	local aggconsume (lnconsume_agg xbmale xbfemale xbjoint i.ssa_aez)
	local foodconsume (lnconsume_food xbmale xbfemale xbjoint i.ssa_aez)
	local cigsal (lnconsume_alctob xbmale xbfemale xbjoint i.ssa_aez)
	local clothing (lnconsume_clothfoot xbmale xbfemale xbjoint i.ssa_aez)
	local recconsume (lnconsume_rec xbmale xbfemale xbjoint i.ssa_aez)
	local educconsume (lnconsume_educ xbmale xbfemale xbjoint i.ssa_aez)	
	local healthconsume (lnconsume_health xbmale xbfemale xbjoint i.ssa_aez)
	local houseconsume (lnconsume_houseutils xbmale xbfemale xbjoint i.ssa_aez)
	local transpoconsume (lnconsume_transpo xbmale xbfemale xbjoint i.ssa_aez)
	local commconsume (lnconsume_comm xbmale xbfemale xbjoint i.ssa_aez)
	local hotresconsume (lnconsume_hotres xbmale xbfemale xbjoint i.ssa_aez)
*	local miscconsume (lnconsume_misc xbmale xbfemale xbjoint i.ssa_aez)
...
* nl tests: compare specific consumption with aggregate 
	...
	*qui: boottest xbfemale, reps (10000)  
	*qui: boottest xbjoint, reps (10000)  
	suest AGCONJ CONFOJ, vce(cluster case_id)
	...
	*qui: boottest xbfemale, reps (10000)  
	*qui: boottest xbjoint, reps (10000) 
	suest AGCONJ CIGSJ, vce(cluster case_id)
	...
	*qui: boottest xbfemale, reps (10000)  
	*qui: boottest xbjoint, reps (10000) 
	suest AGCONJ CLJ, vce(cluster case_id)
	...
	*qui: boottest xbfemale, reps (10000)  
	*qui: boottest xbjoint, reps (10000) 
	suest AGCONJ RECJ, vce(cluster case_id)
	...
	*qui: boottest xbfemale, reps (10000)  
	*qui: boottest xbjoint, reps (10000) 
	suest AGCONJ EDUCJ, vce(cluster case_id)
	...
	*qui: boottest xbfemale, reps (10000)  
	*qui: boottest xbjoint, reps (10000) 
	suest AGCONJ HEAJ, vce(cluster case_id)
	...
	*qui: boottest xbfemale, reps (10000)  
	*qui: boottest xbjoint, reps (10000) 
	suest AGCONJ HOUSEJ, vce(cluster case_id)
	...
	*qui: boottest xbfemale, reps (10000)  
	*qui: boottest xbjoint, reps (10000) 
	suest AGCONJ TRANSJ, vce(cluster case_id)
	...
	*qui: boottest xbfemale, reps (10000)  
	*qui: boottest xbjoint, reps (10000) 
	suest AGCONJ COMJ, vce(cluster case_id)
	...
	*qui: boottest xbfemale, reps (10000)  
	*qui: boottest xbjoint, reps (10000) 
	suest AGCONJ HRESJ, vce(cluster case_id)
...
esttab AGCONJ CONFOJ CIGSJ CLJ RECJ EDUCJ HEAJ HOUSEJ TRANSJ COMJ HRESJ using tab4_spec-mfj-pooled.tex, replace f ///
