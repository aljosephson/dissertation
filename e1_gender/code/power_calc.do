...
* Project: AWARDSS+ Charitable Behavior
* Created on: 24 May 2023
* Created by: alj
* Edited by: alj
* Last edit: 24 May 2023
* Stata v.18
...
*** SAMPLE INFORMATION FROM SHREEDHAR AND MOURATO   
* 0.34 is average effect for group of interest
* 0.25 is average effect in control group 
* 0.5 is standard deviation 

power twomeans 0.34 (0.10(0.05)0.25), sd(0.5) power(0.7 0.8 0.9) graph
